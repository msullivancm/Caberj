...
//Fabio Bianchini - Chamado 6024 - Aberto Pela Joana. Criação de filtro por Grupo de Pagamento. Aumento de quebra.	   
if cEmpAnt == '01'
...
cQuery += "   DECODE(ZZP_TIPPRO,'0','Pgto Mensal','1','Recuperação','2','Bloqueio') TIPPRO,ZZP_STATUS,ZZP_DATDIG,ZZP_MESPAG,ZZP_ANOPAG,"	   				+ CRLF
...
cQuery += "ORDER BY BAU_GRPPAG, DECODE(ZZP_TIPPRO,'0','Pgto Mensal','1','Recuperação','2','Bloqueio'),DECODE(ZZP_STATUS,'CPR','1','PPR','2','CCA','3','PCA','4','5')"
...
PutSX1(cPerg , "07" , "Tipo Protocolo" 	,"","","mv_ch7","N",1,0,0,"C","","","","","mv_par07","Pgto Mensal","","","","Recuperação","","","Bloqueio","","","Pgto e Recup.","","","Todos","","",aHelp,aHelp,aHelp)
