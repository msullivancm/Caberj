		...
		Case ::lMDAnaliseGui .And. !::o790C:lIntSau   
			...
			If lNEstPen //.AND. !::o790C:lRotinaGen
				...
				If ::o790C:lInternacao .And. !::o790C:lEvolucao
					...
					Else
						CoNout("Integridade, NЦo foi possМvel encontrar o BEA com base no BE4 chave [" + B53->B53_NUMGUI + "]")	 //"Integridade, NЦo foi possМvel encontrar o BEA com base no BE4 chave ["
					EndIf   
					oGEN:Destroy()
				EndIf
				//зддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддддд
