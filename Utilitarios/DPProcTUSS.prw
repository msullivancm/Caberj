...
If lSchedule
	...
	If aRet[1]
		...
		QOut(&cDtHrReal + ' - Enviando e-mail de confirma็ใo...')
	EndIf
...
If !aMail[1]
	QOut(&cDtHrReal + " - Erro ao enviar o e-mail de confirma็ใo Atualiza็ใo De/Para Procedimentos TUSS: " + aMail[2])
Else  
	QOut(&cDtHrReal + " - E-mail de confirma็ใo Atualiza็ใo De/Para Procedimentos TUSS enviado.")
EndIf  
