...
@ C(080),C(125) CheckBox ocbSCY Var lcbSCY Prompt "SCY - Historico Pedidos de Compra" Size C(095),C(008) PIXEL OF _oDlg
...
If lcbSED
	...
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = ED_CONTAB" 		,"SED"	,"ED_CONTAB"			," "})
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = ED_CREDIT" 		,"SED"	,"ED_CREDIT"			," "})
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = ED_DEBITO" 		,"SED"	,"ED_DEBITO"			," "})
Endif

If lcbSE1
	// "Contas a Receber"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = E1_DEBITO" 		,"SE1"	,"E1_DEBITO"			," E1_EMISSAO BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = E1_CREDIT" 		,"SE1"	,"E1_CREDIT"			," E1_EMISSAO BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif

If lcbSEU
	// "Movimento do Caixinha"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = EU_CONTA" 		,"SEU"	,"EU_CONTA"			," EU_EMISSAO BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = EU_CONTAD" 		,"SEU"	,"EU_CONTAD"			," EU_EMISSAO BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = EU_CONTAC" 		,"SEU"	,"EU_CONTAC"			," EU_EMISSAO BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif

If lcbSNG
	// "Cadastro de Grupo de Bens"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = NG_CCONTAB" 		,"SNG"	,"NG_CCONTAB"			," " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = NG_CDEPREC" 		,"SNG"	,"NG_CDEPREC"			," " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = NG_CCDEPR" 		    ,"SNG"	,"NG_CCDEPR"			," " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = NG_CDESP" 		    ,"SNG"	,"NG_CDESP"			," " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = NG_CCORREC" 		,"SNG"	,"NG_CCORREC"			," " })
Endif

If lcbSE2
	// "Contas a Pagar"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = E2_CONTAD" 		,"SE2"	,"E2_CONTAD"			," E2_EMISSAO BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = E2_DEBITO" 		,"SE2"	,"E2_DEBITO"			," E2_EMISSAO BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = E2_CREDIT" 		,"SE2"	,"E2_CREDIT"			," E2_EMISSAO BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif
...
*/
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = N3_CCONTAB" 		,"SN3"	,"N3_CCONTAB"		," " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = N3_CDEPREC" 		,"SN3"	,"N3_CDEPREC"		," " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = N3_CCDEPR" 		    ,"SN3"	,"N3_CCDEPR"		," " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = N3_CDESP" 		    ,"SN3"	,"N3_CDESP"			," " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = N3_CCORREC" 		,"SN3"	,"N3_CCORREC"		," " })

Endif

If lcbSB1
	// "Cadastro de Produtos"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = B1_CONTA" 		,"SB1"	,"B1_CONTA"			," " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = B1_CONTAE" 		,"SB1"	,"B1_CONTAE"		," " })
Endif

If lcbSD1
	// "Itens NF Entrada"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = D1_CONTA" 		,"SD1"	,"D1_CONTA"			," D1_DTDIGIT BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif
...
If lcbSBM
	// "Grupo de Produtos"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = BM_CONTA" 		,"SBM"	,"BM_CONTA"			," " })
Endif

If lcbSD3
	// "Movimento Interno"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = D3_CONTA" 		,"SD3"	,"D3_CONTA"			," D3_EMISSAO BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif
...
If lcbSA1
	...
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = A1_CONTA" 		,"SA1"	,"A1_CONTA"			," " })
Endif

If lcbSC1
	// "Solicitacao de Compra"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = C1_CONTA" 		,"SC1"	,"C1_CONTA"			," C1_EMISSAO BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif

If lcbSN6
	// "Saldos Por Conta e item"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = N6_CONTA" 		,"SN6"	,"N6_CONTA"			," N6_DATA BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif
...
If lcbSC7
	// "Pedidos de Compra"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = C7_CONTA" 		,"SC7"	,"C7_CONTA"			," C7_EMISSAO BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif

If lcbCV3
	// "Rastreamento Lancamento"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = CV3_DEBITO" 		,"CV3"	,"CV3_DEBITO"			," CV3_DTSEQ BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = CV3_CREDIT" 		,"CV3"	,"CV3_CREDIT"			," CV3_DTSEQ BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif
...
If lcbSCY
	// "Historico Pedidos de Compra"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = CY_CONTA" 		,"SCY"	,"CY_CONTA"			," CY_EMISSAO BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif

If lcbCT2
	// "Movimento Contabil"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = CT2_CREDIT" 		,"CT2"	,"CT2_CREDIT"			," CT2_DATA BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = CT2_DEBITO" 		,"CT2"	,"CT2_DEBITO"			," CT2_DATA BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif
...
If lcbSCP
	// "SOLICITACOES AO ARMAZEM"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = CP_CONTA" 		,"SCP"	,"CP_CONTA"			,"CP_EMISSAO BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif

// Discutir possibilidade de fazer manualmente
If lcbCT5
// "Lancamentos Padronizados"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = CT5_DEBITO" 		,"CT5"	,"CT5_DEBITO"			," " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = CT5_CREDIT" 		,"CT5"	,"CT5_CREDIT"			," " })
Endif


If lcbBI3
	// "Produto Saude"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = BI3_CONTA" 		,"BI3"	,"BI3_CONTA"			," " })
Endif

If lcbSCQ
	// "PRE-REQUISICOES"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = CQ_CONTA" 		,"SCQ"	,"CQ_CONTA"			,"CQ_DATPRF BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif

If lcbCTK
	// "Arq. Contra Prova"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = CTK_CREDIT" 		,"CTK"	,"CTK_CREDIT"			,"CTK_DATA BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = CTK_DEBITO" 		,"CTK"	,"CTK_DEBITO"			,"CTK_DATA BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif

If lcbCTS
	// "Visoes Gerenciais"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = CTS_CT1FIM" 		,"CTS"	,"CTS_CT1FIM"			," " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = CTS_CT1INI" 		,"CTS"	,"CTS_CT1INI"			," " })
Endif

If lcbSET
	// "Cadastro de Caixinhas"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = ET_CONTA" 		,"SET"	,"ET_CONTA"			,"ET_DTCRIA BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = ET_DEBITO" 		,"SET"	,"ET_DEBITO"			,"ET_DTCRIA BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = ET_CREDIT" 		,"SET"	,"ET_CREDIT"			,"ET_DTCRIA BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif
...
If lcbOUT
 ...
 //	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = ZV_CONTA2" 		,"SZV"	,"ZV_CONTA2"			," " })
	...
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = ZQ_CONTA" 		,"SZQ"	,"ZQ_CONTA"			," " })
	...
	// "Titulos Enviados ao Banco"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = EA_DEBITO" 		,"SEA"	,"EA_DEBITO"			,"EA_DATABOR BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = EA_CREDIT" 		,"SEA"	,"EA_CREDIT"			,"EA_DATABOR BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	
	// "Cadastro de Cheques"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = EF_DEBITO" 		,"SEF"	,"EF_DEBITO"			,"EF_DATA BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = EF_CREDIT" 		,"SEF"	,"EF_CREDIT"			,"EF_DATA BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	
	// "Controle de Aplicacao/Emprestimo"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = EH_DEBITO" 		,"SEH"	,"EH_DEBITO"			,"EH_DATA BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = EH_CREDIT" 		,"SEH"	,"EH_CREDIT"			,"EH_DATA BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	...
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = NC_CONTA" 		,"SNC"	,"NC_CONTA"			,"NC_DATA BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	...
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = BT6_CONTA" 		,"BT6"	,"BT6_CONTA"			," " })
	
	// "Rateio On Line"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = CT9_DEBITO" 		,"CT9"	,"CT9_DEBITO"			," " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = CT9_CREDIT" 		,"CT9"	,"CT9_CREDIT"			," " })
	
	// "Rateio Off Line"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = CTQ_CTORI" 		,"CTQ"	,"CTQ_CTORI"			," " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = CTQ_CTPAR" 		,"CTQ"	,"CTQ_CTPAR"			," " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = CTQ_CTCPAR" 		,"CTQ"	,"CTQ_CTCPAR"			," " })
	
	// "Criterios de Rateio"
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = CTJ_DEBITO" 		,"CTJ"	,"CTJ_DEBITO"			," " })
	aadd(aDePara,{"PB1","PB1_CTNOVA","PB1_FILIAL","PB1_CTVELH = CTJ_CREDIT" 		,"CTJ"	,"CTJ_CREDIT"			," " })
...
If lcbSED
	// "Cadastro de Naturezas"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = ED_CONTAB" 		,"SED"	,"ED_CONTAB"			," "})
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = ED_CREDIT" 		,"SED"	,"ED_CREDIT"			," "})
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = ED_DEBITO" 		,"SED"	,"ED_DEBITO"			," "})
Endif

If lcbSE1
	
	// "Contas a Receber"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = E1_DEBITO" 		,"SE1"	,"E1_DEBITO"			," E1_EMISSAO BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = E1_CREDIT" 		,"SE1"	,"E1_CREDIT"			," E1_EMISSAO BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif
If lcbSEU
	// "Movimento do Caixinha"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = EU_CONTA" 		,"SEU"	,"EU_CONTA"			," EU_EMISSAO BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = EU_CONTAD" 		,"SEU"	,"EU_CONTAD"			," EU_EMISSAO BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = EU_CONTAC" 		,"SEU"	,"EU_CONTAC"			," EU_EMISSAO BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif

If lcbSNG
	// "Cadastro de Grupo de Bens"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = NG_CCONTAB" 		,"SNG"	,"NG_CCONTAB"			," " })
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = NG_CDEPREC" 		,"SNG"	,"NG_CDEPREC"			," " })
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = NG_CCDEPR" 		,"SNG"	,"NG_CCDEPR"			," " })
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = NG_CDESP" 		,"SNG"	,"NG_CDESP"			," " })
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = NG_CCORREC" 		,"SNG"	,"NG_CCORREC"			," " })
Endif
...
If lcbSN3
	// "Cadastro de Saldos e Valores"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = N3_CCONTAB" 		,"SN3"	,"N3_CCONTAB"			," N3_DINDEPR BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = N3_CDEPREC" 		,"SN3"	,"N3_CDEPREC"			," N3_DINDEPR BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = N3_CCDEPR" 		,"SN3"	,"N3_CCDEPR"			," N3_DINDEPR BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = N3_CDESP" 		,"SN3"	,"N3_CDESP"			," N3_DINDEPR BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = N3_CCORREC" 		,"SN3"	,"N3_CCORREC"			," N3_DINDEPR BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif

If lcbSB1
	// "Cadastro de Produtos"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = B1_CONTA" 		,"SB1"	,"B1_CONTA"			," " })
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = B1_CONTAE" 		,"SB1"	,"B1_CONTAE"			," " })
Endif

If lcbSD1
	// "Itens NF Entrada"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = D1_CONTA" 		,"SD1"	,"D1_CONTA"			," D1_DTDIGIT BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif

If lcbSN4
	// "Movimentacoes do Ativo Fixo"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = N4_CONTA" 		,"SN4"	,"N4_CONTA"			," N4_DATA BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif

If lcbSBM
	// "Grupo de Produtos"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = BM_CONTA" 		,"SBM"	,"BM_CONTA"			," " })
Endif

If lcbSD3
	// "Movimento Interno"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = D3_CONTA" 		,"SD3"	,"D3_CONTA"			," D3_EMISSAO BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif
...
If lcbSC1
	// "Solicitacao de Compra"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = C1_CONTA" 		,"SC1"	,"C1_CONTA"			," C1_EMISSAO BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif

If lcbSN6
	// "Saldos Por Conta e item"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = N6_CONTA" 		,"SN6"	,"N6_CONTA"			," N6_DATA BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif
...
If lcbSC7
	// "Pedidos de Compra"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = C7_CONTA" 		,"SC7"	,"C7_CONTA"			," C7_EMISSAO BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif

If lcbCV3
	// "Rastreamento Lancamento"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = CV3_DEBITO" 		,"CV3"	,"CV3_DEBITO"			," CV3_DTSEQ BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = CV3_CREDIT" 		,"CV3"	,"CV3_CREDIT"			," CV3_DTSEQ BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif

If lcbSA6
	// "Cadastro de Bancos"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = A6_CONTA" 		,"SA6"	,"A6_CONTA"			," " })
...
If lcbCT2
	// "Movimento Contabil"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = CT2_CREDIT" 		,"CT2"	,"CT2_CREDIT"			," CT2_DATA BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = CT2_DEBITO" 		,"CT2"	,"CT2_DEBITO"			," CT2_DATA BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif
...
If lcbSCP
	// "SOLICITACOES AO ARMAZEM"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = CP_CONTA" 		,"SCP"	,"CP_CONTA"			,"CP_EMISSAO BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif

// Discutir possibilidade de fazer manualmente
If lcbCT5
// "Lancamentos Padronizados"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = CT5_DEBITO" 		,"CT5"	,"CT5_DEBITO"			," " })
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = CT5_CREDIT" 		,"CT5"	,"CT5_CREDIT"			," " })
Endif

If lcbBI3
	// "Produto Saude"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = BI3_CONTA" 		,"BI3"	,"BI3_CONTA"			," " })
Endif

If lcbSCQ
	// "PRE-REQUISICOES"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = CQ_CONTA" 		,"SCQ"	,"CQ_CONTA"			,"CQ_DATPRF BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif

If lcbCTK
	// "Arq. Contra Prova"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = CTK_CREDIT" 		,"CTK"	,"CTK_CREDIT"			,"CTK_DATA BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = CTK_DEBITO" 		,"CTK"	,"CTK_DEBITO"			,"CTK_DATA BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif

If lcbCTS
	// "Visoes Gerenciais"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = CTS_CT1FIM" 		,"CTS"	,"CTS_CT1FIM"			," " })
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = CTS_CT1INI" 		,"CTS"	,"CTS_CT1INI"			," " })
Endif

If lcbSET
	// "Cadastro de Caixinhas"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = ET_CONTA" 		,"SET"	,"ET_CONTA"		    	,"ET_DTCRIA BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = ET_DEBITO" 		,"SET"	,"ET_DEBITO"			,"ET_DTCRIA BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = ET_CREDIT" 		,"SET"	,"ET_CREDIT"			,"ET_DTCRIA BETWEEN '"+DtoS(mv_par01)+"' AND '"+DtoS(mv_par02)+"' " })
Endif         
...
If lcbOUT
 ...
 //	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = ZV_CONTA2" 		,"SZV"	,"ZV_CONTA2"			," " })
	...
	// "Rateio On Line"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = CT9_DEBITO" 		,"CT9"	,"CT9_DEBITO"			," " })
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = CT9_CREDIT" 		,"CT9"	,"CT9_CREDIT"			," " })
	...
	// "Criterios de Rateio"
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = CTJ_DEBITO" 	,"CTJ"	,"CTJ_DEBITO"			," " })
	aadd(aDiverg,{"PB1","PB1_CTVELH","PB1_FILIAL","PB1_CTVELH = CTJ_CREDIT" 	,"CTJ"	,"CTJ_CREDIT"			," " })
